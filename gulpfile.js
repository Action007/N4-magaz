...
exports.default =
  series(clean, parallel(htmlinclude, scripts, json, fonts, resources, imgToApp, svgSprites), styles, watchFiles);
...
const tinypng = () => {
  return src([
    ...
    .pipe(tiny({
      key: 'Y4PgY5DDpGPRlb33RKJ7G1LmhZ0x3HQW',
      log: true,
      parallel: true,
      parallelMax: 50,
    }))
...
exports.build =
  series(clean, parallel(htmlinclude, htmlMinify, scriptsBuild, fonts, resources, imgToApp, svgSprites),
    stylesBuild, tinypng);
